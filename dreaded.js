...
const botname = process.env.BOTNAME || 'DEADPOOL MD';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐃𝐞𝐚𝐝𝐩𝐨𝐨𝐥-𝐚𝐢';
    const packname = process.env.STICKER_PACKNAME || '𝐃𝐞𝐚𝐝𝐩𝐨𝐨𝐥';
...
const admin = process.env.ADMIN_MSG || '𝐇𝐮𝐡!\n𝐀𝐝𝐦𝐢𝐦𝐬 𝐨𝐧𝐥𝐲, 𝐃𝐮𝐦𝐦𝐲.';
    ...
    const NotOwner = process.env.NOT_OWNER_MSG || '𝐃𝐞𝐚𝐝𝐩𝐨𝐨𝐥 𝐨𝐧𝐥𝐲༒︎ ';
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"	✦𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐃𝐞𝐚𝐝𝐩𝐨𝐨𝐥-𝐌𝐃! ☫"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃-! ☬...'})
...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/e11dae3f03d05cf1fc970.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
client.sendMessage(from,{image:krt.result,caption:"Done by 𝐃𝐄𝐀𝐃𝐏𝐎𝐎-𝐌𝐃 "}, {quoted:m})
}
break;	
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐀𝐈✞︎'); 
} catch (errr) { 
        ...
        try {
            ...
            if (fileSizeInMegabytes <= 100) {
                client.sendMessage(
                    from, {
                        video: fs.readFileSync(`./${randomName}`),
                        caption: `𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃`,
                    }, {
                        quoted: m
                    }
                );
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`) 
 } 
 break;
...
const audiovn = "./somiya.mp3";
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝐁𝐎𝐖 𝐃𝐎𝐖𝐍 𝐓𝐎,𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃 𝐈𝐒 𝐀𝐋𝐈𝐕𝐄 𝐀𝐍𝐃 𝐊𝐈𝐂𝐊𝐈𝐍𝐆☔",
          body: "https://chat.whatsapp.com/EPSGKau0IVi7J5lyOJO7Jk",
          thumbnailUrl: "https://telegra.ph/file/620a18062216605296404.jpg",
          sourceUrl: "https://chat.whatsapp.com/EPSGKau0IVi7J5lyOJO7Jk",
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
break;
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃 ✞︎*`}, { quoted: m }) 
...
case "movie": 
 ...
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/9cc4ec8f3b7622bce1a65.mp4' }, caption: `𝐇𝐞𝐫𝐞 𝐢𝐬 𝐦𝐲 𝐚𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 𝐜𝐫𝐞𝐚𝐭𝐨𝐫, +254741188211 ☤☬` }, {quoted: m}); 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ 𝐃𝐄𝐀𝐃𝐏𝐎𝐎𝐋-𝐌𝐃 𝐁𝐎𝐓𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/577a6110252ac21e40b9b.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
